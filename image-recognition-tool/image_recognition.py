...
def parse_image_path():
	...
	if not args["image"].endswith(".png"):
		parser.error('specified file has a wrong extension, only *.png images are allowed')
...
if __name__ == "__main__":
	...
	save_results(img_file, image, full_for_hybrid, full_for_sun, result_type, sun_center, daytime)
